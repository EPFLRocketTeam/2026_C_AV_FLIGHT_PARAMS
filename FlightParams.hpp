...
struct PressurizationParams {
    FIXED   uint32_t LaunchDelayMs = 11.2f SECONDS;
    DYNAMIC uint32_t HoldDelayMs   = 10.f SECONDS;
    ...
    DYNAMIC float MinFuelNominalPressure = -1.9f;
...
struct BurnParams {
    ...
    DYNAMIC uint32_t FcMaxDurationMs           = 0.5 SECONDS;
