...
struct PressurizationParams {
    ...
    DYNAMIC float MaxLoxNominalPressure  = 9.f;
    DYNAMIC float MinLoxNominalPressure  = 7.f;
    DYNAMIC float MaxFuelNominalPressure = 9.f;
    DYNAMIC float MinFuelNominalPressure = 7.f;
};
